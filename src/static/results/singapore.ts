...
export const singaporeGPResult = [
	...
	new DriverResultDTO(drivers.RYU).setPos(7).setStartingPos(12).setDNF(),
	new DriverResultDTO(drivers.JULIAN_SOSA).setPos(8).setStartingPos(7).setDNF(),
	new DriverResultDTO(drivers.FACULANUS).setPos(9).setStartingPos(11).setDNF(),
	new DriverResultDTO(drivers.MAX).setPos(10).setStartingPos(8).setDNF(),
	new DriverResultDTO(drivers.PEPPA).setPos(11).setStartingPos(6).setDNF(),
	new DriverResultDTO(drivers.EMI).setPos(12).setStartingPos(10).setDNF(),
];